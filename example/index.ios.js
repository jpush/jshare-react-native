...
export default class JShare {
     ...
     * {
     *  type: 'file' 
     *  platform: platformString  // (iOS wechat_timeLine 不支持) 
     *  path: String // 必填，文件路径
     *  tile: String
     *  fileExt: String
     * }
     ...
     * {
     *  type: 'app'
     *  platform: platformString  // (iOS wechat_favourite 不支持) 
     *  url: String
     *  extInfo: String
     *  path: String
     *  title: String
     ...
     *  imagePath: String // 选填，本地图片路径 imagePath，imageUrl 必须二选一, (iOS 只能是 imagePath)
